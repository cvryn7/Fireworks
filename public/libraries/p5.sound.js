...
(function (root, factory) {
  if (typeof define === 'function' && define.amd)
    define('p5.sound', ['../../../../Downloads/p5.js-sound-master/p5.js-sound-master/lib/p5'], function (p5) { (factory(p5));});
...
src_app = function () {
  var p5SOUND = sndcore;
  return p5SOUND;
}(sndcore, master, helpers, errorHandler, panner, soundfile, amplitude, fft, signal, oscillator, env, pulse, noise, audioin, filter, eq, delay, reverb, metro, looper, compressor, soundRecorder, peakdetect, gain, distortion);
}));